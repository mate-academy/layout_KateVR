...
import img1 from '../icon/education.svg';
import img2 from '../icon/building.svg';
import img3 from '../icon/power.svg';
import img4 from '../icon/users.svg';
import img5 from '../icon/network.svg';
import img6 from '../icon/computer.svg';
import img7 from '../icon/wi-fi.svg';

export const experience = [
    {
    nameObject: 'experience',
    image: img1,
    title: 'EDUCATION',
